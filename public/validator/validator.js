...
var validator = (function($){
    ...
    */
    message = {
        invalid         : 'texto invalido',
        checked         : 'debes dar check',
        empty           : 'porfavor pon algo aqui',
        min             : 'texto es muy corto',
        max             : 'texto es muy largo',
        number_min      : 'muy bajo',
        number_max      : 'muy alto',
        url             : 'URL invalida',
        number          : 'no es un numero',
        email           : 'direccion de correo incorrecta',
        email_repeat    : 'el correo no coincide',
        password_repeat : 'la contraseña no coincide',
        repeat          : 'no coincide',
        complete        : 'campo no esta completo',
